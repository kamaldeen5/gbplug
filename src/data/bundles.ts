...
export const NETWORK_BUNDLES: Record<string, BundleOption[]> = {
  mtn: [
    { id: 'mtn-1',  productId: 'e5825a25-f365-4926-b78e-8a5b7d2a1c40', name: '1 GB',  data: '1 GB',  costPrice: 4.00,   price: 4.77,   validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-2',  productId: 'b285a7da-adea-4bdd-be49-8dd54ad2663f', name: '2 GB',  data: '2 GB',  costPrice: 8.00,   price: 9.54,   validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-3',  productId: '211647ff-747a-4c00-99d1-f793ced9755c', name: '3 GB',  data: '3 GB',  costPrice: 12.00,  price: 14.31,  validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-4',  productId: 'd56621a9-875a-496d-b216-cc21cb5bae02', name: '4 GB',  data: '4 GB',  costPrice: 16.00,  price: 19.08,  validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-5',  productId: '440262fb-f6fe-4c43-89f3-b6c470f24fea', name: '5 GB',  data: '5 GB',  costPrice: 20.00,  price: 23.85,  validity: '90 Days', popular: true, serviceType: 'mtn_flexa' },
    { id: 'mtn-6',  productId: '81cc78fc-3e21-45f0-ac54-1fafa3f01923', name: '6 GB',  data: '6 GB',  costPrice: 24.00,  price: 28.62,  validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-8',  productId: '45caa58f-397c-41d2-a4f1-48ad8d6e1b23', name: '8 GB',  data: '8 GB',  costPrice: 33.00,  price: 39.38,  validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-10', productId: '56456480-f69d-4cb2-8d0f-fd90e5a3e7b7', name: '10 GB', data: '10 GB', costPrice: 40.00,  price: 47.70,  validity: '90 Days', popular: true, serviceType: 'mtn_flexa' },
    { id: 'mtn-15', productId: 'c5418c3a-83fb-461b-ba61-59c1583d5699', name: '15 GB', data: '15 GB', costPrice: 59.00,  price: 70.38,  validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-20', productId: '02c2d960-3676-4e34-b96e-3791b8c2b16c', name: '20 GB', data: '20 GB', costPrice: 78.00,  price: 93.02,  validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-25', productId: '6912f2a7-8c03-4ef3-9be3-292e1ba407ed', name: '25 GB', data: '25 GB', costPrice: 98.00,  price: 116.87, validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-30', productId: 'a18f4d14-fac2-4277-901e-d8732b3cfa8e', name: '30 GB', data: '30 GB', costPrice: 119.00, price: 141.93, validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-40', productId: '6be0cb96-ba7e-4bb1-a993-82cbc4adca62', name: '40 GB', data: '40 GB', costPrice: 160.00, price: 190.80, validity: '90 Days', serviceType: 'mtn_flexa' },
    { id: 'mtn-50', productId: '4545d0f0-1181-40e0-83b0-f78a8984824f', name: '50 GB', data: '50 GB', costPrice: 195.00, price: 232.56, validity: '90 Days', serviceType: 'mtn_flexa' },
  ],
  telecel: [
...
// Regular Normal MTN product mapping helper for manual dispatches
export const REGULAR_MTN_PACKAGES: { gb: number; name: string; productId: string; cost: number }[] = [
  { gb: 1,  name: '1 GB',  productId: '17490299-29e5-4e73-bcae-85be8ed68972', cost: 4.00 },
  { gb: 2,  name: '2 GB',  productId: '15f90b99-ae56-41d1-bc86-0770ba7d8d74', cost: 8.00 },
  { gb: 3,  name: '3 GB',  productId: 'cb0f6cf3-efa5-4cc1-a1a9-27ac095130a0', cost: 12.00 },
  { gb: 4,  name: '4 GB',  productId: 'd5898b8c-9979-4a09-bc52-f08430157498', cost: 16.00 },
  { gb: 5,  name: '5 GB',  productId: 'ca208754-ed35-4f7a-af14-f103691947c8', cost: 20.00 },
  { gb: 6,  name: '6 GB',  productId: 'f6a726a5-f3cb-43fb-afa1-bd273337057d', cost: 24.00 },
  { gb: 8,  name: '8 GB',  productId: 'c6625d9d-722b-4f33-bf20-9a7eba9a3d6a', cost: 33.00 },
  { gb: 10, name: '10 GB', productId: '16527bc5-9832-476d-913f-1f1abc7e79e8', cost: 40.00 },
  { gb: 15, name: '15 GB', productId: '3c78af77-a372-4bf8-9a5b-23dc7c45a134', cost: 59.00 },
  { gb: 20, name: '20 GB', productId: 'b6cdc71b-7701-46fa-b773-9fd92a241c1f', cost: 78.00 },
  { gb: 25, name: '25 GB', productId: '61cf3850-edb2-48c7-8ccd-15a6a7ce7737', cost: 98.00 },
  { gb: 30, name: '30 GB', productId: '90dde8e8-320c-4580-98ec-cabdc77a00ee', cost: 119.00 },
